...
××××××××××××××××××××××××××××××××××××××××××××
DEVELOPER : T4N1N C9B4R 
GITHUB    : T4N1NC9B4R
VERSION   : 2.0
PROJECT   : SMS BOMBER 
FACEBOOK  : hacker tanin
××××××××××××××××××××××××××××××××××××××××××××"""
  for i in logo:
    sys.stdout.write(i)
    sys.stdout.flush()
...
""")
  os.system("xdg-open https://www.facebook.com/profile.php?id=100094364312640")
  sys.exit()
baner= os.system("figlet -f slant T4NN1N")
baner = str(baner)
